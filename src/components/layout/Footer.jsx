      ...
      <div className="max-w-7xl mx-auto px-6 lg:px-12 py-16">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-12 gap-10 lg:gap-12">
            ...
            <div className="flex gap-2.5 pt-2">
              {[
                ...
                <a 
                  key={label} 
                  href="#" 
                  className="w-8 h-8 rounded-full flex items-center justify-center bg-white/60 text-silver hover:bg-gold/10 hover:text-gold hover:border-gold/30 border border-silver-dark/15 transition-all duration-300" 
                  aria-label={label} 
                  title={label}
                >
          ...
          <div className="lg:col-span-2">
            ...
            <ul className="space-y-3">
              {[
                ...
                <li key={to}>
                  <Link to={to} className="text-silver hover:text-gold hover:translate-x-1 inline-block transition-all duration-200 text-xs sm:text-sm no-underline">{label}</Link>
                </li>
              ))}
            </ul>
          </div>
          ...
          <div className="lg:col-span-2">
            ...
            <ul className="space-y-3">
              {['Chính sách đổi trả', 'Hướng dẫn mua hàng', 'Câu hỏi thường gặp', 'Liên hệ'].map((item) => (
                <li key={item}>
                  <a href="#" className="text-silver hover:text-gold hover:translate-x-1 inline-block transition-all duration-200 text-xs sm:text-sm no-underline">{item}</a>
                </li>
              ))}
            </ul>
          </div>
          ...
          <div className="lg:col-span-4 space-y-4 text-left">
            ...
            <div className="space-y-3.5 text-xs sm:text-sm text-silver font-light">
              <p className="flex items-start gap-2.5">
                <span className="text-gold shrink-0">📍</span>
                <span>123 Luxury Road, Phường Bến Nghé, Quận 1, TP. Hồ Chí Minh</span>
              </p>
              <p className="flex items-center gap-2.5">
                <span className="text-gold shrink-0">📞</span>
                <span>0123 456 789 (Hotline 24/7)</span>
              </p>
              <p className="flex items-center gap-2.5">
                <span className="text-gold shrink-0">✉️</span>
                <span>contact@ecommerce.com</span>
              </p>
              <p className="flex items-center gap-2.5 pt-2 border-t border-silver-dark/10">
                <span className="text-gold shrink-0">🕒</span>
                <span>Giờ mở cửa: 09:00 - 21:30 (Hằng ngày)</span>
              </p>
            </div>
          </div>
