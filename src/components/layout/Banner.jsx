...
// Component Banner trang chủ (Hero Banner) - Đại diện cho phong cách thiết kế sang trọng (luxury design)
const Banner = () => {
  return (
    <section className="relative min-h-[90vh] flex items-center overflow-hidden pt-24 pb-16 bg-obsidian" aria-label="Banner chào mừng">
      {/* Các vòng tròn ánh sáng chuyển động ở nền (Animated Light Mesh Circles) tạo chiều sâu 3D */}
      ...
      {/* Lớp lưới nền mờ ảo (Grid Pattern Overlay) */}
      ...
      <div className="max-w-7xl mx-auto px-6 lg:px-12 w-full relative z-10">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
          ...
          {/* Cột Trái (Left Column): Tiêu đề chính, đoạn mô tả ngắn và Nút kêu gọi hành động (CTA) */}
          <div className="lg:col-span-7 space-y-6 text-left animate-fade-in-up">
            ...
            <div className="flex flex-wrap items-center gap-4 pt-4">
              {/* Nút hành động chính: Săn Sale (Định hướng trang sản phẩm) */}
              ...
              {/* Nút hành động phụ: Xem tất cả sản phẩm */}
            ...
            {/* Khối hiển thị thông số nhanh (Micro Stats Bar) */}
          ...
          <div className="lg:col-span-5 relative flex justify-center lg:justify-end animate-fade-in-up [animation-delay:0.2s]">
            ...
            {/* Các icon ngôi sao lấp lánh (Shimmering Star lines) di chuyển nhẹ bằng hiệu ứng animate-float */}
            ...
            {/* Khung viền mờ kính (Glassmorphic Frame) bao bọc hình ảnh sản phẩm */}
            <div className="relative z-10 w-full max-w-[340px] sm:max-w-[380px] rounded-3xl p-3 bg-white/40 backdrop-blur-md border border-white/60 shadow-elevated transition-transform duration-500 hover:rotate-1 hover:scale-[1.02]">
              <div className="relative overflow-hidden rounded-2xl aspect-[4/5] bg-obsidian-light border border-gold/10">
                <img 
                  src={bannerHero} 
                  alt="Trưng bày mỹ phẩm cao cấp" 
                  className="w-full h-full object-cover object-center animate-scale-in"
                  loading="eager"
                />
                {/* Lớp thông tin nổi kính mờ đè lên góc dưới của ảnh sản phẩm */}
                <div className="absolute bottom-4 left-4 right-4 glass-card rounded-xl p-3 border border-white/40 flex items-center justify-between">
                  <div>
                    <span className="text-[9px] text-silver-dark uppercase tracking-widest block font-bold">Bộ sưu tập mới</span>
